...
public class SpellRpcs : NetworkBehaviour
{
    ...
    public void SpawnProjectileServerRpc(ulong clientId, int slot, float posx, float posy, float posz) {
        ...
        flyScript.Target = player.GetComponent<PlayerAbilities>().Targets[player.GetComponent<PlayerAbilities>().currTarget].transform;
